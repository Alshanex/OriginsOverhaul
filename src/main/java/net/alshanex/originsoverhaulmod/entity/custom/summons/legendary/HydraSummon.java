...
public class HydraSummon extends EntityHydra implements MagicSummon {

    public HydraSummon(EntityType<? extends EntityHydra> pEntityType, Level pLevel) {
        super((EntityType<EntityHydra>) pEntityType, pLevel);
        xpReward = 0;
    }

    public HydraSummon(Level level, LivingEntity owner) {
        this(ModEntities.SUMMONED_HYDRA.get(), level);
        setSummoner(owner);
    }
    ...
    public void onRemovedFromWorld() {
        ItemStack soul = new ItemStack(ModItems.HYDRA_SOUL.get(),1);
