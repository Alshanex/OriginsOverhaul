...
public class CoralGolemSummon extends Coral_Golem_Entity implements MagicSummon {
    ...
    public CoralGolemSummon(EntityType<? extends Coral_Golem_Entity> pEntityType, Level pLevel) {
        super(pEntityType, pLevel);
        xpReward = 0;
    }

    public CoralGolemSummon(Level level, LivingEntity owner) {
        this(ModEntities.SUMMONED_CORAL_GOLEM.get(), level);
        setSummoner(owner);
    }
