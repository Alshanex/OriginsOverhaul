...
public class WitherSkeletonSummon extends WitherSkeleton implements MagicSummon, GeoAnimatable {
    private static final EntityDataAccessor<Boolean> DATA_IS_ANIMATING_RISE = SynchedEntityData.defineId(WitherSkeletonSummon.class, EntityDataSerializers.BOOLEAN);
    ...
    public WitherSkeletonSummon(Level level, LivingEntity owner, boolean playRiseAnimation) {
        this(ModEntities.SUMMONED_WITHER_SKELETON.get(), level);
        setSummoner(owner);
