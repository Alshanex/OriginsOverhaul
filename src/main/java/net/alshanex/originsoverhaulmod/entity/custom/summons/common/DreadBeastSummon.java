...
public class DreadBeastSummon extends EntityDreadBeast implements MagicSummon {

    public DreadBeastSummon(EntityType<? extends EntityDreadBeast> pEntityType, Level pLevel) {
        super(pEntityType, pLevel);
        xpReward = 0;
    }

    public DreadBeastSummon(Level level, LivingEntity owner) {
        this(ModEntities.SUMMONED_DREAD_BEAST.get(), level);
        setSummoner(owner);
    }
