...
public class RoyalDraugrSummon extends Royal_Draugr_Entity implements MagicSummon {

    public RoyalDraugrSummon(EntityType<? extends Royal_Draugr_Entity> pEntityType, Level pLevel) {
        super(pEntityType, pLevel);
        xpReward = 0;
    }

    public RoyalDraugrSummon(Level level, LivingEntity owner) {
        this(ModEntities.SUMMONED_ROYAL_DRAUGR.get(), level);
        setSummoner(owner);
    }
