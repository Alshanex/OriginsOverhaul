...
public class DrownedSummon extends Drowned implements MagicSummon {
    public DrownedSummon(EntityType<? extends Drowned> pEntityType, Level pLevel) {
        super(pEntityType, pLevel);
        xpReward = 0;
    }

    public DrownedSummon(Level level, LivingEntity owner) {
        this(ModEntities.SUMMONED_DROWNED.get(), level);
        setSummoner(owner);
    }
