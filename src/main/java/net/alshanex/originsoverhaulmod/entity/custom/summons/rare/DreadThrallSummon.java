...
public class DreadThrallSummon extends EntityDreadThrall implements MagicSummon {

    public DreadThrallSummon(EntityType<? extends EntityDreadThrall> pEntityType, Level pLevel) {
        super(pEntityType, pLevel);
        xpReward = 0;
    }

    public DreadThrallSummon(Level level, LivingEntity owner) {
        this(ModEntities.SUMMONED_DREAD_THRALL.get(), level);
        setSummoner(owner);
    }
