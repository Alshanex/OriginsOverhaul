...
public class WadjetSummon extends Wadjet_Entity implements MagicSummon {

    public WadjetSummon(EntityType<? extends Wadjet_Entity> pEntityType, Level pLevel) {
        super(pEntityType, pLevel);
        xpReward = 0;
    }

    public WadjetSummon(Level level, LivingEntity owner) {
        this(ModEntities.SUMMONED_WADJET.get(), level);
        setSummoner(owner);
    }
    ...
    public void onRemovedFromWorld() {
        ItemStack soul = new ItemStack(ModItems.WADJET_SOUL.get(),1);
