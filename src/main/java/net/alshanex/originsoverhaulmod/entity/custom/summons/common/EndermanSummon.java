...
public class EndermanSummon extends EnderMan implements MagicSummon {

    public EndermanSummon(EntityType<? extends EnderMan> pEntityType, Level pLevel) {
        super(pEntityType, pLevel);
        xpReward = 0;
    }

    public EndermanSummon(Level level, LivingEntity owner) {
        this(ModEntities.SUMMONED_ENDERMAN.get(), level);
        setSummoner(owner);
    }
    ...
    public void registerGoals() {
        ...
        this.goalSelector.getAvailableGoals().removeIf(goal ->
                goal.getGoal() instanceof MeleeAttackGoal || goal.getGoal() instanceof LookAtPlayerGoal || goal.getGoal() instanceof HurtByTargetGoal
        );
