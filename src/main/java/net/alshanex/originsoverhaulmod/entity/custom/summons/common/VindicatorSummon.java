...
public class VindicatorSummon extends Vindicator implements MagicSummon {

    public VindicatorSummon(EntityType<? extends Vindicator> pEntityType, Level pLevel) {
        super(pEntityType, pLevel);
        xpReward = 0;
    }

    public VindicatorSummon(Level level, LivingEntity owner) {
        this(ModEntities.SUMMONED_VINDICATOR.get(), level);
        setSummoner(owner);
    }
