...
public class DreadGhoulSummon extends EntityDreadGhoul implements MagicSummon {

    public DreadGhoulSummon(EntityType<? extends EntityDreadGhoul> pEntityType, Level pLevel) {
        super(pEntityType, pLevel);
        xpReward = 0;
    }

    public DreadGhoulSummon(Level level, LivingEntity owner) {
        this(ModEntities.SUMMONED_DREAD_GHOUL.get(), level);
        setSummoner(owner);
    }
