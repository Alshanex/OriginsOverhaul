package net.alshanex.originsoverhaulmod.entity.custom.summons.rare;
...
public class EliteDraugrSummon extends Elite_Draugr_Entity implements MagicSummon {

    public EliteDraugrSummon(EntityType<? extends Elite_Draugr_Entity> pEntityType, Level pLevel) {
        super(pEntityType, pLevel);
        xpReward = 0;
    }

    public EliteDraugrSummon(Level level, LivingEntity owner) {
        this(ModEntities.SUMMONED_ELITE_DRAUGR.get(), level);
        setSummoner(owner);
    }
    ...
    public void registerGoals() {
        ...
        this.goalSelector.getAvailableGoals().removeIf(goal ->
                goal.getGoal() instanceof HurtByTargetGoal || goal.getGoal() instanceof NearestAttackableTargetGoal || goal.getGoal() instanceof LookAtPlayerGoal
        );
