...
public class EnderGolemSummon extends Ender_Golem_Entity implements MagicSummon {

    public EnderGolemSummon(EntityType<? extends Ender_Golem_Entity> pEntityType, Level pLevel) {
        super(pEntityType, pLevel);
        xpReward = 0;
    }

    public EnderGolemSummon(Level level, LivingEntity owner) {
        this(ModEntities.SUMMONED_ENDER_GOLEM.get(), level);
        setSummoner(owner);
    }
    ...
    public void onRemovedFromWorld() {
        ItemStack soul = new ItemStack(ModItems.ENDER_GOLEM_SOUL.get(),1);
