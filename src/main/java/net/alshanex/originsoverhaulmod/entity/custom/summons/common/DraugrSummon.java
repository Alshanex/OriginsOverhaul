...
public class DraugrSummon extends Draugr_Entity implements MagicSummon {

    public DraugrSummon(EntityType<? extends Draugr_Entity> pEntityType, Level pLevel) {
        super(pEntityType, pLevel);
        xpReward = 0;
    }

    public DraugrSummon(Level level, LivingEntity owner) {
        this(ModEntities.SUMMONED_DRAUGR.get(), level);
        setSummoner(owner);
    }
