...
public class AmethystCrabSummon extends Amethyst_Crab_Entity implements MagicSummon {

    public AmethystCrabSummon(EntityType<? extends Amethyst_Crab_Entity> pEntityType, Level pLevel) {
        super(pEntityType, pLevel);
        xpReward = 0;
    }

    public AmethystCrabSummon(Level level, LivingEntity owner) {
        this(ModEntities.SUMMONED_AMETHYST_CRAB.get(), level);
        setSummoner(owner);
    }
    ...
    public void registerGoals() {
        ...
        this.goalSelector.getAvailableGoals().removeIf(goal ->
                goal.getGoal() instanceof HurtByTargetGoal || goal.getGoal() instanceof LookAtPlayerGoal
        );
    ...
    public void onRemovedFromWorld() {
        ItemStack soul = new ItemStack(ModItems.AMETHYST_CRAB_SOUL.get(),1);
