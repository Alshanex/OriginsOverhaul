...
public class KoboletonSummon extends Koboleton_Entity implements MagicSummon {

    public KoboletonSummon(EntityType<? extends Koboleton_Entity> pEntityType, Level pLevel) {
        super(pEntityType, pLevel);
        xpReward = 0;
    }

    public KoboletonSummon(Level level, LivingEntity owner) {
        this(ModEntities.SUMMONED_KOBOLETON.get(), level);
        setSummoner(owner);
    }
