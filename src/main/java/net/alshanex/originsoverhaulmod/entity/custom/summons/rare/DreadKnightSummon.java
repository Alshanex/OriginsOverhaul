...
public class DreadKnightSummon extends EntityDreadKnight implements MagicSummon {

    public DreadKnightSummon(EntityType<? extends EntityDreadKnight> pEntityType, Level pLevel) {
        super(pEntityType, pLevel);
        xpReward = 0;
    }

    public DreadKnightSummon(Level level, LivingEntity owner) {
        this(ModEntities.SUMMONED_DREAD_KNIGHT.get(), level);
        setSummoner(owner);
    }
