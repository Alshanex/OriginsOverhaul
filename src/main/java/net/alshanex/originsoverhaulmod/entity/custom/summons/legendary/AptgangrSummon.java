...
public class AptgangrSummon extends Aptrgangr_Entity implements MagicSummon {

    public AptgangrSummon(EntityType<? extends Aptrgangr_Entity> pEntityType, Level pLevel) {
        super(pEntityType, pLevel);
        xpReward = 0;
    }

    public AptgangrSummon(Level level, LivingEntity owner) {
        this(ModEntities.SUMMONED_APTGANGR.get(), level);
        setSummoner(owner);
    }
    ...
    public void onRemovedFromWorld() {
        ItemStack soul = new ItemStack(ModItems.APTGANGR_SOUL.get(),1);
