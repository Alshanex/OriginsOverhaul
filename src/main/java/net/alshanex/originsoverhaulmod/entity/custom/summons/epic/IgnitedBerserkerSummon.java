...
public class IgnitedBerserkerSummon extends Ignited_Berserker_Entity implements MagicSummon {

    public IgnitedBerserkerSummon(EntityType<? extends Ignited_Berserker_Entity> pEntityType, Level pLevel) {
        super(pEntityType, pLevel);
        xpReward = 0;
    }

    public IgnitedBerserkerSummon(Level level, LivingEntity owner) {
        this(ModEntities.SUMMONED_IGNITED_BERSERKER.get(), level);
        setSummoner(owner);
    }
    ...
    public void onRemovedFromWorld() {
        ...
        if (random.nextFloat() < 0.5) {
            ItemStack soul = new ItemStack(ModItems.IGNITED_BERSERKER_SOUL.get(), 1);
