...
public class KobolediatorSummon extends Kobolediator_Entity implements MagicSummon {

    public KobolediatorSummon(EntityType<? extends Kobolediator_Entity> pEntityType, Level pLevel) {
        super(pEntityType, pLevel);
        xpReward = 0;
    }

    public KobolediatorSummon(Level level, LivingEntity owner) {
        this(ModEntities.SUMMONED_KOBOLEDIATOR.get(), level);
        setSummoner(owner);
    }
    ...
    public void onRemovedFromWorld() {
        ItemStack soul = new ItemStack(ModItems.KOBOLEDIATOR_SOUL.get(),1);
